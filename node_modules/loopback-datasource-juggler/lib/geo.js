...
function geoDistance(x1, y1, x2, y2, options) {
    ...
    var R = EARTH_RADIUS[type];
    /**
     x1 = x1 * DEG2RAD;
     y1 = y1 * DEG2RAD;
     x2 = x2 * DEG2RAD;
     y2 = y2 * DEG2RAD;
     var a = Math.pow(Math.sin(deg2rad( y2 - y1 ) / 2.0), 2);
     var b = Math.pow(Math.sin(deg2rad( x2 - x1 ) / 2.0), 2);
     var c = Math.sqrt(a + Math.cos(deg2rad(y2)) * Math.cos(deg2rad(y1)) * b);
     */
...
var lat1 = -27.453202;
var long1 = -58.9875545;
var lat2 =-27.4631396;
var long2 = -58.9912876;

console.log(geoDistance(lat1, long1, lat2, long2, {type:"kilometers"}));
